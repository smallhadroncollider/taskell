...
test_seq =
    testGroup "Data.Taskell.Seq" [
        testGroup "extract" [
          ...
          , testCase "Out of range - positive" (
                assertEqual
                    "Nothing"
                    Nothing
                    (extract 5 testSeq)
          ...
          , testCase "Out of range - negative" (
                assertEqual
                    "Nothing"
                    Nothing
                    (extract (-1) testSeq)
      ...
      , testGroup "shiftBy" [
          ...
          , testCase "Ridiculous right shift" (
                assertEqual
                    "Moves to right-most"
                    (Just (fromList [1, 2, 4, 5, 3]))
          ...
          , testCase "Ridiculous left shift" (
                assertEqual
                    "Moves to left-most"
